...
public struct ExternalAccountKey: Codable, Equatable, CustomDebugStringConvertible {
  ...
  /// It is generated by the PublicCertificateAuthorityService
  /// when the ExternalAccountKey is created
  public let b64MacKey: Data

  public var debugDescription: String {
    "ExternalAccountKey(name: \(name), keyID: \(keyID), b64MacKey: \(b64MacKey))"
  }
}
